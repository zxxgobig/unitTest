...
require_once dirname(__FILE__).'/PHPUnit/TestCase.php';
require_once dirname(__FILE__).'/PHPUnit/TestResult.php';
require_once dirname(__FILE__).'/PHPUnit/TestSuite.php';
/**
